      ...
      <div className="relative z-10">
        ...
        <header className="bg-[#0f141b] border-b border-[#2a2a2a] relative overflow-hidden">
            ...
            <div className="flex justify-between items-center py-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative" ref={notificationRef}>
                   ...
                   {showNotifications && (
                     <div className="fixed top-20 right-4 w-80 h-[55vh] bg-[#0f141b] border border-[#2a2a2a] rounded-xl shadow-2xl z-[9999]  overflow-y-auto">
                      ...
                      <div className="py-2">
                        {notifications.length === 0 ? (
                          ...
                          notifications.map((notification) => (
                            <div
                              key={notification.id}
                              className={`px-4 py-3 hover:bg-[#181d23] transition-colors cursor-pointer ${
         ...
         <main className="flex-1 flex h-screen">
           ...
           <div className="w-64 bg-[#0f141b] border-r border-[#2a2a2a] p-6 flex-shrink-0">
               ...
               {!selectedUser ? (
                 <div className="h-96 flex items-center justify-center">
                   <div className="text-center">
                     ...
                     <p className="text-sm text-gray-500">Go to Active Users to select a user to chat with</p>
                     <button
                       onClick={() => setActiveTab('users')}
                       className="mt-4 px-4 py-2 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-lg hover:from-blue-600 hover:to-green-600 transition-all duration-200"
                     >
                       Select User
                     </button>
                   </div>
                   ...
                   <div className="border-t border-[#2a2a2a] p-4">
                     <div className="flex space-x-2">
                       <input
                         ...
                         className="flex-1 px-3 py-2 bg-[#2a2a2a] border border-[#3a3a3a] rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                       />
                       <button
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                 {activeUsers.map((user) => (
                   <div
                     ...
                     className="bg-[#0f141b] border border-[#2a2a2a] rounded-2xl p-6 shadow-lg hover:border-blue-500/50 transition-all duration-200 cursor-pointer group"
                   >
                     <div className="flex items-center space-x-4">
                       {/* Avatar */}
                       <div className="relative">
